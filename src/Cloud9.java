...
public class Cloud9 extends CSGOTeams {
	private String biggestWin;

	
	public Cloud9(String teamName, String teamColor, String region, String player1, String player2, String player3, String player4, String player5){
